...
namespace PasswordManager.DAL.EFCore.Migrations
{
    ...
    [Migration("20220413061341_full_db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PasswordManager.DAL.EFCore.Entities.EncryptionAlgorithm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PasswordManager.DAL.EFCore.Entities.PasswordDb", b =>
                {
                    ...
                    b.Property<int>("EncryptionAlgorithmId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("EncryptionAlgorithmId");
            ...
            modelBuilder.Entity("PasswordManager.DAL.EFCore.Entities.PasswordDb", b =>
                {
                    b.HasOne("PasswordManager.DAL.EFCore.Entities.EncryptionAlgorithm", "EncryptionAlgorithm")
                        .WithMany("PasswordDbs")
                        .HasForeignKey("EncryptionAlgorithmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EncryptionAlgorithm");
                });

            modelBuilder.Entity("PasswordManager.DAL.EFCore.Entities.EncryptionAlgorithm", b =>
                {
                    b.Navigation("PasswordDbs");
                });
